...
export function ProfilePage() {
  ...
  return (
    <Stack spacing={2}>
      ...
      >
        <Tabs value={tab} onChange={(_, v) => setTab(v as TabValue)} sx={{ borderBottom: 1, borderColor: 'divider', mb: 2 }}>
          <Tab label="Resumo" value="resumo" />
          <Tab label="Dados e conta" value="conta" />
        </Tabs>
        ...
        {tab === 'conta' && (
          <Stack spacing={3}>
            <Box component="form" onSubmit={handleSaveProfile}>
              <Typography variant="subtitle1" sx={{ fontWeight: 700, mb: 1.5 }}>Nome e e-mail</Typography>
              <Stack spacing={2} sx={{ maxWidth: 400 }}>
                ...
                <TextField
                  ...
                  autoComplete="email"
                />
                {profileError && <Typography color="error" sx={{ fontSize: 14 }}>{profileError}</Typography>}
                {profileSuccess && <Typography color="success.main" sx={{ fontSize: 14 }}>Dados salvos.</Typography>}
            ...
            <Box component="form" onSubmit={handleChangePassword}>
              <Typography variant="subtitle1" sx={{ fontWeight: 700, mb: 1.5 }}>Alterar senha</Typography>
              <Stack spacing={2} sx={{ maxWidth: 400 }}>
                <TextField
                  label="Senha atual"
                  type="password"
                ...
                <TextField
                  ...
                  autoComplete="new-password"
                />
                {passwordError && <Typography color="error" sx={{ fontSize: 14 }}>{passwordError}</Typography>}
                {passwordSuccess && <Typography color="success.main" sx={{ fontSize: 14 }}>Senha alterada.</Typography>}
